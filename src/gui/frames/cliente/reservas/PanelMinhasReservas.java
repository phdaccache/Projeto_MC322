...
public class PanelMinhasReservas extends JPanel {
	private static final long serialVersionUID = 1L;
	private JLabel iconX;
	
	public PanelMinhasReservas(Cliente cliente) {
		setBounds(0, 0, 346, 396);
		setLayout(null);
		setVisible(true);
		
		JLabel lblNewLabel = new JLabel("MINHAS RESERVAS");
		...
		String string = cliente.listarReservas();
