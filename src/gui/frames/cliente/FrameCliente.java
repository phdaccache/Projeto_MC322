...
import gui.frames.cliente.emprestimos.FrameEmprestimos;
import gui.frames.cliente.itens.FrameItens;
	...
	public FrameCliente() {
		...
		contentPane.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				FrameCliente.this.requestFocus();
			}
		});
		...
		dragPanel.addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseDragged(MouseEvent e) {
				FrameCliente.this.setLocation(FrameCliente.this.getX() + e.getX() - mouseX, FrameCliente.this.getY()+e.getY()-mouseY);
			}
		});
		...
		pnlMinhaConta.setBounds(193, 27, 210, 40);
		...
		pnlItens.setBounds(193, 67, 210, 40);
		...
		pnlEmprestimos.setBounds(193, 107, 210, 40);
		...
		pnlReservas.setBounds(193, 147, 210, 40);
