...
public class PanelListarArtigos extends JPanel {
	private static final long serialVersionUID = 1L;
	private JLabel iconX;
	
	public PanelListarArtigos(Biblioteca biblioteca) {
		setBounds(0, 0, 346, 396);
		setLayout(null);
		setVisible(true);
		
		JLabel lblNewLabel = new JLabel("LISTAR ARTIGOS");
		...
		String string = biblioteca.listarArtigos();
