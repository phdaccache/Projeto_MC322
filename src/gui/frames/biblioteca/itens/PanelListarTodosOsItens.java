...
public class PanelListarTodosOsItens extends JPanel {
	private static final long serialVersionUID = 1L;
	private JLabel iconX;
	
	public PanelListarTodosOsItens(Biblioteca biblioteca) {
		setBounds(0, 0, 346, 396);
		setLayout(null);
		setVisible(true);
		
		JLabel lblNewLabel = new JLabel("LISTAR TODOS OS ITENS");
		...
		String string = biblioteca.listarItens();
