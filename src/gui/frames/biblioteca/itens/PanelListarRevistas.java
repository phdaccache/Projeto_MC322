...
public class PanelListarRevistas extends JPanel {
	private static final long serialVersionUID = 1L;
	private JLabel iconX;
	
	public PanelListarRevistas(Biblioteca biblioteca) {
		setBounds(0, 0, 346, 396);
		setLayout(null);
		setVisible(true);
		
		JLabel lblNewLabel = new JLabel("LISTAR REVISTAS");
		...
		String string = biblioteca.listarRevistas();
