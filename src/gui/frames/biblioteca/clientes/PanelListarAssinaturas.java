...
public class PanelListarAssinaturas extends JPanel {
	private static final long serialVersionUID = 1L;
	private JLabel iconX;
	
	public PanelListarAssinaturas(Biblioteca biblioteca) {
		setBounds(0, 0, 346, 396);
		setLayout(null);
		setVisible(true);
		
		JLabel lblNewLabel = new JLabel("LISTAR ASSINATURAS");
		...
		String string = biblioteca.listarAssinaturas();
