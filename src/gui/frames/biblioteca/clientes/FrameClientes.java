...
public class FrameClientes extends JFrame {
	...
	public FrameClientes() {
		...
		pnlListarClientes.setBorder(new MatteBorder(0, 0, 1, 0, (Color) MyColor.TEXT));
		pnlListarClientes.setBackground(MyColor.PRIMARY);
		...
		lblListarClientes.setForeground(MyColor.BACKGROUND);
		...
		pnlListarEstudantes.setBorder(new MatteBorder(0, 0, 1, 0, (Color) MyColor.TEXT));
		pnlListarEstudantes.setBackground(MyColor.PRIMARY);
		...
		pnlListarProfessores.setBorder(new MatteBorder(0, 0, 1, 0, (Color) MyColor.TEXT));
		pnlListarProfessores.setBackground(MyColor.PRIMARY);
		...
		pnlCadastrarCliente.setBorder(new MatteBorder(0, 0, 1, 0, (Color) MyColor.TEXT));
		...
		pnlExcluirCliente.setBorder(new MatteBorder(0, 0, 1, 0, (Color) MyColor.TEXT));
		...
		pnlListarAssinaturas.setBorder(new MatteBorder(0, 0, 1, 0, (Color) MyColor.TEXT));
		...
		pnlGerarAssinatura.setBorder(new MatteBorder(0, 0, 1, 0, (Color) MyColor.TEXT));
