...
public class PanelListarTodosOsEmprestimos extends JPanel {
	private static final long serialVersionUID = 1L;
	private JLabel iconX;
	
	public PanelListarTodosOsEmprestimos(Biblioteca biblioteca) {
		...
		String string = biblioteca.listarEmprestimos();
